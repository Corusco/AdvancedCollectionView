...
@property (nonatomic, strong) AAPLGenericOf(AAPLKeyValueDataSource, AAPLCat *) *classificationDataSource;
@property (nonatomic, strong) AAPLGenericOf(AAPLTextValueDataSource, AAPLCat *) *descriptionDataSource;
@end
