 ...
 */
@interface AAPLGenericOf(AAPLDataSource, ItemType) : NSObject <UICollectionViewDataSource, AAPLContentLoading>
...
- (nullable AAPLUseGeneric(ItemType))itemAtIndexPath:(NSIndexPath *)indexPath;

/// Find the index paths of the specified item in the data source. An item may appear more than once in a given data source.
- (AAPLArrayG(NSIndexPath *) *)indexPathsForItem:(AAPLUseGeneric(ItemType))item;
...
- (AAPLArrayG(AAPLAction *) *)primaryActionsForItemAtIndexPath:(NSIndexPath *)indexPath;
...
- (AAPLArrayG(AAPLAction *) *)secondaryActionsForItemAtIndexPath:(NSIndexPath *)indexPath;
...
- (void)notifyItemsInsertedAtIndexPaths:(AAPLArrayG(NSIndexPath *) *)insertedIndexPaths;
...
- (void)notifyItemsRemovedAtIndexPaths:(AAPLArrayG(NSIndexPath *) *)removedIndexPaths;
...
- (void)notifyItemsRefreshedAtIndexPaths:(AAPLArrayG(NSIndexPath *) *)refreshedIndexPaths;
