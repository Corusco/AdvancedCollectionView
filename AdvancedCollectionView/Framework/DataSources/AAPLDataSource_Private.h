...
- (AAPLDictionaryG(NSNumber *, AAPLDataSourceSectionMetrics *) *)snapshotMetrics;
...
- (AAPLArrayG(NSIndexPath *) *)indexPathsForSupplementaryItem:(AAPLSupplementaryItem *)supplementaryItem header:(BOOL)header;
...
- (void)dataSource:(AAPLDataSource *)dataSource didInsertItemsAtIndexPaths:(AAPLArrayG(NSIndexPath *) *)indexPaths;
- (void)dataSource:(AAPLDataSource *)dataSource didRemoveItemsAtIndexPaths:(AAPLArrayG(NSIndexPath *) *)indexPaths;
- (void)dataSource:(AAPLDataSource *)dataSource didRefreshItemsAtIndexPaths:(AAPLArrayG(NSIndexPath *) *)indexPaths;
...
- (void)dataSource:(AAPLDataSource *)dataSource didUpdateSupplementaryItem:(AAPLSupplementaryItem *)supplementaryItem atIndexPaths:(AAPLArrayG(NSIndexPath *) *)indexPaths header:(BOOL)header;
