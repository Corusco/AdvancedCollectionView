...
- (AAPLArrayG(NSIndexPath *) *)localIndexPathsForGlobalIndexPaths:(AAPLArrayG(NSIndexPath *) *)globalIndexPaths;

/// Return an array of global index paths from an array of local index paths
- (AAPLArrayG(NSIndexPath *) *)globalIndexPathsForLocalIndexPaths:(AAPLArrayG(NSIndexPath *) *)localIndexPaths;
