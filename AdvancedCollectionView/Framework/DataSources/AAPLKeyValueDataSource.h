 ...
 */
@interface AAPLGenericOf(AAPLKeyValueDataSource, SourceType) : AAPLGenericOf(AAPLBasicDataSource, AAPLKeyValueItem *)
...
- (instancetype)initWithObject:(nullable AAPLUseGeneric(SourceType))object NS_DESIGNATED_INITIALIZER;
...
@property (nullable, nonatomic, strong) AAPLUseGeneric(SourceType) object;
