...
@interface AAPLGenericOf(AAPLBasicDataSource, ItemType) : AAPLGenericOf(AAPLDataSource, ItemType)
 ...
 */
@property (nonatomic, copy) AAPLArrayG(ItemType) *items;
 ...
 */
- (void)setItems:(AAPLArrayG(ItemType) *)items animated:(BOOL)animated;
