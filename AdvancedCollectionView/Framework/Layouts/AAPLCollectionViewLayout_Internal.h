...
@property (nonatomic) CGRect frame;
@property (nonatomic, strong, readonly) AAPLArrayG(AAPLLayoutCell *) *items;
...
@property (nonatomic, readonly) AAPLArrayG(AAPLLayoutSupplementaryItem *) *pinnableHeaders;
@property (nonatomic, readonly) AAPLArrayG(AAPLLayoutSupplementaryItem *) *nonPinnableHeaders;
